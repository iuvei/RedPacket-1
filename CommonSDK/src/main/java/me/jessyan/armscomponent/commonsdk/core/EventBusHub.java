...
public interface EventBusHub {
     ...
     * 即时通讯分组
     */
    String EVENTBUS_IM_UNREAD_COUNT = IM  + "/UPIM_UNREAD_COUNT";
    String EVENTBUS_IM_REFRESH_CONVERSATION= IM  + "/UPIM_REFRESH_CONVERSATION";
    String EVENTBUS_IM_REFRESH_CONVERSATION_LIST= IM  + "/UPIM_REFRESH_CONVERSATION_LIST";
