...
public class QrConfig implements Serializable {
    ...
    public  int CORNER_COLOR = Color.parseColor("#06CB7E");
    public  int LINE_COLOR = Color.parseColor("#06CB7E");

    public  int TITLE_BACKGROUND_COLOR = Color.parseColor("#ffffff");
    public  int TITLE_TEXT_COLOR = Color.parseColor("#06CB7E");
    ...
    public String title_text = "扫一扫";
    public String des_text = "将二维码放入框内，即可自动扫描";
