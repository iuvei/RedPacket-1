...
public class CustomChatRowGift extends EaseChatRow{

	private TextView tvGiftName,tvHit;
	private ImageView imgGift;

    public CustomChatRowGift(Context context, EMMessage message, int position, BaseAdapter adapter) {
	...
	protected void onInflateView() {
		inflater.inflate(message.direct() == EMMessage.Direct.RECEIVE ?
				R.layout.custom_row_received_gift : R.layout.custom_row_sent_gift, this);
	}
...
//        contentView.setText(span, BufferType.SPANNABLE);
        try {
            ...
            if(message.direct() == EMMessage.Direct.RECEIVE){
                tvHit.setText(R.string.send_you_a_gift);
            }else{
                tvHit.setText(R.string.you_send_a_gift);
            }
