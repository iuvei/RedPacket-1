    ...
    public void onSetUpView() {
        ...
        if(emojicon != null){
            if(emojicon.getBigIcon() != 0){
                EaseImageUtils.display2PlaceholderImage(context,emojicon.getBigIcon(),R.drawable.ease_default_expression,imageView);
            }else if(emojicon.getBigIconPath() != null){
                EaseImageUtils.display2PlaceholderImage(context,emojicon.getBigIconPath(),R.drawable.ease_default_expression,imageView);
            }else{
