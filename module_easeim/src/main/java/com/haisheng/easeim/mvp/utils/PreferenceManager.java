...
public class PreferenceManager {
	...
	private String SHARED_KEY_DISABLED_GROUPS = "shared_key_disabled_groups";
	private String SHARED_KEY_DISABLED_IDS = "shared_key_disabled_ids";
...
//	}
	...
	public List<String> getDisabledIds() {
		...
		String sIds = mSharedPreferences.getString(SHARED_KEY_DISABLED_IDS, null);
		if(null != sIds){
...
//		String sIds = Joiner.on(",").join(ids);
		editor.putString(SHARED_KEY_DISABLED_IDS, "");
		editor.apply();
	}

	public List<String> getDisabledGroups() {
		List<String> groups = null;
		String sGroups = mSharedPreferences.getString(SHARED_KEY_DISABLED_GROUPS, null);
		if(null != sGroups){
			groups = Arrays.asList(sGroups.split(","));
		}
		return groups;
	}

	public void setDisableGroups(List<String> groups){
//		String sGroups = Joiner.on(",").join(groups);
		editor.putString(SHARED_KEY_DISABLED_GROUPS, "");
		editor.apply();
	}
