...
public class UnderLineListAdapter extends RecyclerView.Adapter <UnderLineListAdapter.ViewHolder> {
    ...
    private List <UnderLineBean> data;
    private ItemClickListener itemClickListener;

    public UnderLineListAdapter(Context context, List <UnderLineBean> data) {
    ...
    public void setDatas(List <UnderLineBean> datas){
        this.data = datas;
        notifyDataSetChanged();
    }
    public void addData(List <UnderLineBean> data){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        holder.tvCreatDate.setText ( data.get ( position ).getCreatDate () );
