 ...
 * 提现记录adapter
 */
public class WithdrawalRecordAdapter extends RecyclerView.Adapter <WithdrawalRecordAdapter.ViewHolder> {

    private Context context;
    private List <WithdrawalRecordBean> data;
    private ItemClickListener itemClickListener;

    public WithdrawalRecordAdapter(Context context, List <WithdrawalRecordBean> data) {
