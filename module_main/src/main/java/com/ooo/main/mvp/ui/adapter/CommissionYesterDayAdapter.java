 ...
 * description
 */
public class CommissionYesterDayAdapter extends BaseListAdapter <RankingBean.ResultBean.YesterdayBean> {

    public CommissionYesterDayAdapter(List <RankingBean.ResultBean.YesterdayBean> list) {
        super ( list );
    }
