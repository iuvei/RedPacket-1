...
public interface LuckyWheelContract {
    ...
    interface View extends IView {
        ...
        void getLuckyDrawSettingSuccess(LuckyDrawSettingBean.ResultBean result);

        void getLuckyDrawSettingFail();

        void getLuckyDrawResultSuccess(StartLuckyDrawBean.ResultBean result);

        void getLuckyDrawResultFail();
    }
