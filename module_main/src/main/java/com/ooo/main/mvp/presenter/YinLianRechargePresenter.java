 ...
 */
@ActivityScope
public class YinLianRechargePresenter extends BasePresenter <IModel, YinLianRechargeContract.View> {
    @Inject
    ...
    ApiModel apiModel;
    @Inject
    public YinLianRechargePresenter(YinLianRechargeContract.View rootView) {
        super ( rootView );
        ...
        apiModel.getRechargeMoneyList (  )
                ...
                .subscribe ( new ErrorHandleSubscriber <RechargeMoneyBean> (mErrorHandler) {
                    ...
                    public void onNext(RechargeMoneyBean bean) {
                        if (bean.getStatus ()==1) {
                            mRootView.getRechargeMoneyListSuccess(bean.getResult ().getBank ());
                        }else{
